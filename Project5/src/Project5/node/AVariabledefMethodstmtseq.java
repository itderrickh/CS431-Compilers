...
public final class AVariabledefMethodstmtseq extends PMethodstmtseq
{
    private TId _id_;
    ...
    public AVariabledefMethodstmtseq()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVariabledefMethodstmtseq(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAVariabledefMethodstmtseq(this);
    }
